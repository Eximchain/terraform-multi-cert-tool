...
variable "domain_prefixes" {
  description = "List of domain prefixes to make certificates for. Each certificate will be valid for one prefix."
  type        = "list"
}

variable "sub_domain" {
  description = "The root domain that the certs will be created for"
}
